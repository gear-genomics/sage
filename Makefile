...
# Flags
CXX=g++
CXXFLAGS += -std=c++11 -O3 -DNDEBUG -isystem ${EBROOTHTSLIB} -isystem ${TEAL_ROOT} -isystem ${SDSL_ROOT}/include -pedantic -W -Wall -fvisibility=hidden
...
src/sage: .sdsl .htslib ${IDXSOURCES}
